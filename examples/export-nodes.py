...
param_0 = device.parameter_new('param.0', value=-1, datatype='decimal', tags=['uno','dos'], \
                                 priority=-1, domain=[0,1], clipmode='both', \
                                 repetitionsFilter=1)
...
print(param_1.write('/Volumes/work/Users/reno/Documents/GITs/pybush/examples/export-test_param_1'))